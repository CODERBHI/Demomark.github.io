...
<div class="oceanwp-mb-field">
	...
	<# if ( data.src ) { #>
		<img class="butterbean-img" src="httpcoderbhi.github.io/Demomark.github.io//wp-content/plugins/ocean-extra/includes/metabox/controls/image/{{ data.src }}" alt="{{ data.alt }}">
	<# } else { #>
